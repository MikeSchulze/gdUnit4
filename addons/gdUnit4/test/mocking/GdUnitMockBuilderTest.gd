...
func test_double_return_untyped_function_with_args() -> void:
	...
	var expected := [
		...
		"	",
		"	if false == false and __working_mode == GdUnitMock.CALL_REAL_FUNC:",
		"		return super.disconnect(signal_, callable_)",
		"	return null",
		""]
	assert_array(doubler.double(fd)).contains_exactly(expected)
...
func test_double_untyped_function_with_varargs() -> void:
	...
	var expected := [
		"func emit_custom(signal_, vararg0_=\"__null__\", vararg1_=\"__null__\", vararg2_=\"__null__\", vararg3_=\"__null__\", vararg4_=\"__null__\", vararg5_=\"__null__\", vararg6_=\"__null__\", vararg7_=\"__null__\", vararg8_=\"__null__\", vararg9_=\"__null__\"):",
		"	var varargs :Array = __filter_vargs([vararg0_, vararg1_, vararg2_, vararg3_, vararg4_, vararg5_, vararg6_, vararg7_, vararg8_, vararg9_])",
		...
		"	if false == false and __working_mode == GdUnitMock.CALL_REAL_FUNC:",
		"		match varargs.size():",
		"			0: return super.emit_custom(signal_)",
		"			1: return super.emit_custom(signal_, varargs[0])",
		"			2: return super.emit_custom(signal_, varargs[0], varargs[1])",
		"			3: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2])",
		"			4: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2], varargs[3])",
		"			5: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2], varargs[3], varargs[4])",
		"			6: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2], varargs[3], varargs[4], varargs[5])",
		"			7: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2], varargs[3], varargs[4], varargs[5], varargs[6])",
		"			8: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2], varargs[3], varargs[4], varargs[5], varargs[6], varargs[7])",
		"			9: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2], varargs[3], varargs[4], varargs[5], varargs[6], varargs[7], varargs[8])",
		"			10: return super.emit_custom(signal_, varargs[0], varargs[1], varargs[2], varargs[3], varargs[4], varargs[5], varargs[6], varargs[7], varargs[8], varargs[9])",
		"	return null",
		""]
	assert_array(doubler.double(fd)).contains_exactly(expected)
...
func test_double_virtual_script_function_with_arg() -> void:
	...
	var expected := [
		...
		"	",
		"	if true == false and __working_mode == GdUnitMock.CALL_REAL_FUNC:",
		"		return super._input(event_)",
		"	return null",
		""]
	assert_array(doubler.double(fd)).contains_exactly(expected)

func test_mock_on_script_path_without_class_name() -> void:
	var script := GdUnitMockBuilder.mock_on_script(null, "res://addons/gdUnit4/test/mocker/resources/ClassWithoutNameA.gd", [], false);
...
func test_mock_on_script_path_with_custom_class_name() -> void:
	...
	var script := GdUnitMockBuilder.mock_on_script(null, "res://addons/gdUnit4/test/mocker/resources/ClassWithCustomClassName.gd", [], false);
...
func test_mock_on_class_with_class_name() -> void:
	var script := GdUnitMockBuilder.mock_on_script(null, ClassWithNameA, [], false);
...
func test_mock_on_class_with_custom_class_name() -> void:
	# the class contains a class_name definition
	var script := GdUnitMockBuilder.mock_on_script(null, GdUnit_Test_CustomClassName, [], false);
	assert_that(script.resource_name).is_equal("MockGdUnitTestCustomClassName.gd")
	assert_that(script.get_instance_base_type()).is_equal("Resource")
	# finally check the mocked script is valid
	assert_int(script.reload()).is_equal(OK)
