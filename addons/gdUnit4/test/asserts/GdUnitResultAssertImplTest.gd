...
func test_is_empty():
	...
	assert_failure(func(): assert_result(Result.warn("a warning")).is_empty()) \
		.is_failed() \
		.has_message("Expecting the result must be a EMPTY but was WARNING:\n 'a warning'")
	assert_failure(func(): assert_result(Result.error("a error")).is_empty()) \
		.is_failed() \
...
func test_is_success():
	...
	assert_failure(func(): assert_result(Result.warn("a warning")).is_success()) \
		.is_failed() \
		.has_message("Expecting the result must be a SUCCESS but was WARNING:\n 'a warning'")
	assert_failure(func(): assert_result(Result.error("a error")).is_success()) \
		.is_failed() \
...
func test_is_warning():
	...
	assert_failure(func(): assert_result(Result.success("value")).is_warning()) \
		.is_failed() \
		.has_message("Expecting the result must be a WARNING but was SUCCESS.")
	assert_failure(func(): assert_result(Result.error("a error")).is_warning()) \
		.is_failed() \
...
func test_is_error():
	...
	assert_failure(func(): assert_result(Result.success("")).is_error()) \
		.is_failed() \
		.has_message("Expecting the result must be a ERROR but was SUCCESS.")
	assert_failure(func(): assert_result(Result.warn("a warning")).is_error()) \
		.is_failed() \
...
func test_contains_message():
	...
	assert_failure(func(): assert_result(Result.success("")).contains_message("Error 500")) \
		.is_failed() \
		.has_message("Expecting:\n 'Error 500'\n but the Result is a success.")
	assert_failure(func(): assert_result(Result.warn("Warning xyz!")).contains_message("Warning aaa!")) \
		.is_failed() \
		.has_message("Expecting:\n 'Warning aaa!'\n but was\n 'Warning xyz!'.")
	assert_failure(func(): assert_result(Result.error("Error 410")).contains_message("Error 500")) \
		.is_failed() \
		.has_message("Expecting:\n 'Error 500'\n but was\n 'Error 410'.")
...
func test_is_value():
	...
	assert_failure(func(): assert_result(Result.success("")).is_value("abc")) \
		.is_failed() \
		.has_message("Expecting to contain same value:\n 'abc'\n but was\n '<empty>'.")
	assert_failure(func(): assert_result(Result.success("abc")).is_value("")) \
		.is_failed() \
		.has_message("Expecting to contain same value:\n '<empty>'\n but was\n 'abc'.")
	assert_failure(func(): assert_result(Result.success(result_value)).is_value("")) \
		.is_failed() \
		.has_message("Expecting to contain same value:\n '<empty>'\n but was\n <Node>.")
...
func test_override_failure_message() -> void:
	assert_failure(func(): assert_result(Result.success("")) \
